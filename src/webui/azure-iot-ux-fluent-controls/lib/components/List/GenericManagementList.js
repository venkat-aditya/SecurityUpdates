...
const React = require("react"),
    ...
    css = classNames.bind(require("./GenericManagementList.module.scss"));
/**
    ...
    render() {
        ...
        this.props.columns.forEach((column, colIndex) => {
            ...
            if (sortable) {
                ...
                if (this.props.sortedColumn === column) {
                    ...
                    labelSuffix = React.createElement(Icon_1.Icon, {
                        icon: icon,
                        fontSize: 12,
                    ...
                    onClick =
                        column.defaultDirection === "descending"
                ...
                this.props.rows.map((row, rowIndex) => {
                    ...
                    if (column.mapColumn instanceof Function) {
                        ...
                        if (
                            ...
                            console.error(
                                "Method Error: Management List Column property mapColumn must return a valid React Node"
                            );
                        }
                    }
        ...
        if (this.props.onSelect && this.props.isSelected) {
            const selected = this.props.rows.map((row) =>
                ...
                allSelected =
                    selected.filter((row) => row).length === selected.length,
                checkboxCol = [],
                selectAll = !this.props.onSelectAll
                    ...
                    : React.createElement(CheckboxInput_1.CheckboxInput, {
                          ...
                          label: React.createElement(
                              ...
                              { className: css("select-all-label") },
                          ...
                          checked: allSelected,
                          onChange: (newValue) =>
                              this.props.onSelectAll(newValue),
            ...
            this.props.rows.forEach((row, index) => {
                ...
                if (this.props.selectLabel instanceof Function) {
                    ...
                    if (
                        ...
                        console.error(
                            "Method Error: Management List Column property selectLabel must return a valid React Node"
                        );
                    }
                }
                const isSelected =
                ...
                checkboxCol.push(
                    React.createElement(
                        Attributes_1.Elements.div,
                        {
                            ...
                            key: `select-${index}`,
                            attr: Attributes_1.mergeAttributes(
                                this.props.attr.selectRowContent,
                                row.attr
                            ),
                        },
                        React.createElement(CheckboxInput_1.CheckboxInput, {
                            ...
                            checked: isSelected,
                            onChange: (newValue) =>
                                this.props.onSelect(row, newValue),
                            attr: Attributes_1.mergeAttributeObjects(
        ...
        return React.createElement(
            ...
            columns.map((col, index) => {
                const style = {},
                    offset = columns.length - this.props.columns.length;
                    ...
                    Attributes_1.Elements.div,
                    {
                        className: css("column", {
                            checkbox:
                                ...
                                !!this.props.onSelect,
                            "auto-width":
                                index >= offset ? !column.width : false,
                        }),
                        key: index,
                        style: style,
                        attr: Attributes_1.mergeAttributes(
                            this.props.attr.column,
                            column.attr
                        ),
                    },
                    col
