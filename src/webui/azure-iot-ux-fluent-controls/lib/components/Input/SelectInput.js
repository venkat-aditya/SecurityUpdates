...
const React = require("react"),
    ...
    css = classNames.bind(require("./SelectInput.module.scss"));
/**
...
exports.SelectInput = (props) => {
    const containerClass = css("combo-container", props.className),
        comboClass = css("combo", { error: props.error }),
        arrowClassName = css("arrow", "icon icon-chevronDown4Legacy");
    let value = -1,
